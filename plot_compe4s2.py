...
dir = "./id3rifp1.0tp2.5amp2.0/finite/vs4/"
dir1 = "./id3rifp1.0tp2.5amp2.0/finite/vs5/"
dir2 = "./id3rifp1.0tp2.5amp2.0/finite/vs10/"
...
x1 = _x1+dx/2
ax1.plot(x1,strxz.iloc[strxz_absmax_tim,:42].abs(),c="c",linestyle="solid",label=label)
ax1.plot(x1,strxz1.iloc[strxz_absmax_tim1,:42].abs(),c="m",linestyle="solid",label=label1)
ax1.plot(x1,strxz2.iloc[strxz_absmax_tim2,:42].abs(),c="y",linestyle="solid",label=label2)
# ax1.plot(x1,strxz3.iloc[strxz_absmax_tim3,:42].abs()*100,c="#a65628",linestyle="solid",label=label3)
plt.legend(edgecolor="None",facecolor="None")
filename = "shearst-c-vs2.png"
fig.savefig(filename, bbox_inches="tight", pad_inches=0.05)

plt.clf()
fig = plt.figure(figsize=(10,4),dpi=300)
ax1 = fig.add_subplot(1,1,1,xlabel=r"$x$[m]",ylabel="volume strain",xlim=(0,210),ylim=(0.00,0.018))
ax1.plot(x1,vstr.iloc[vstr_max_tim,:42].abs(),c="c",linestyle="--",label=label )
ax1.plot(x1,vstr1.iloc[vstr_max_tim1,:42].abs(),c="m",linestyle="--",label=label1 )
ax1.plot(x1,vstr2.iloc[vstr_max_tim2,:42].abs(),c="y",linestyle="--",label=label2 )
# ax1.plot(x1,vstr3.iloc[vstr_max_tim3,:42].abs()*100,c="#a65628",linestyle="--",label=label3 )
plt.legend(edgecolor="None",facecolor="None")
filename = "volst-c-vs2.png"
fig.savefig(filename, bbox_inches="tight", pad_inches=0.05)
