...
ax1 = fig.add_subplot(1,1,1,xlabel=r"$V_s\mathrm{[m/s]}$",ylabel=r"$displacement\mathrm{[m]}$",xmargin=0,yscale="log",ylim=(10**(-10),10**(-1)))
...
##mode-2
fig = plt.figure(figsize=(6,4),dpi=300)
ax2 = fig.add_subplot(1,1,1,xlabel=r"$V_s\mathrm{[m/s]}$",ylabel=r"$displacement\mathrm{[m]}$",xmargin=0,yscale="log",ylim=(10**(-10),10**(-1)))
